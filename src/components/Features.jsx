  ...
  const features = [
    {
      ...
      description: "Clean, distraction-free timer interface with customizable work and break intervals. Stay focused with visual progress indicators."
    },
    {
      icon: (
        <svg width="48" height="48" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      description: "Plan your day, organize tasks by priority, and select what to focus on during each Pomodoro session."
    },
    {
      icon: (
        <svg width="48" height="48" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M3 3V21H21" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
          <path d="M9 9L13 5L17 9L21 7" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
      ),
      title: "Detailed Analytics",
      description: "Track your productivity patterns, view session history, and understand how you spend your time with beautiful charts."
    },
    {
      icon: (
        <svg width="48" height="48" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      description: "Earn adorable birds for every completed session! Build your collection and unlock rare species as you stay consistent."
    },
    {
      icon: (
        <svg width="48" height="48" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      description: "Adjust timer lengths, break intervals, notification sounds, and app appearance to match your workflow."
    },
    {
      icon: (
        <svg width="48" height="48" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      description: "Gentle reminders and motivational messages to keep you on track without being disruptive."
    }
  ]
    ...
    <section id="features" className="features">
      <div className="container">
        <div className="section-header">
          <h2>Powerful Features for Smart Productivity</h2>
          <p>
            Everything you need to focus better and achieve your goals in one
